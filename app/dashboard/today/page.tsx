        ...
        <div className="rounded-[2rem] bg-white p-6 shadow-sm">
          ...
          {data.next ? (
            <div className="grid gap-4">
              <div className="rounded-3xl bg-indigo-50 p-5 text-3xl font-black text-indigo-950">Noch {data.next.countdownLabel}</div>
              <EventCard item={data.next} people={data.familyMembers} />
            </div>
          ) : <div className="rounded-3xl bg-emerald-50 p-8 text-5xl font-black text-emerald-950">Heute nichts mehr geplant 🎉</div>}
        </div>
      </section>
